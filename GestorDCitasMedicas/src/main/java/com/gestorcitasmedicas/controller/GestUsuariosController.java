...
public class GestUsuariosController {
    ...
    @FXML
    private TableColumn<Usuario, Double> colPeso;
    
    @FXML
    private TableColumn<Usuario, Double> colAltura;
    ...
    private void configurarTabla() {
        ...
        colAltura.setCellValueFactory(cellData -> 
            new javafx.beans.property.SimpleDoubleProperty(cellData.getValue().getAltura()).asObject());
